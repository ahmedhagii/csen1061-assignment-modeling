...
```{r, message=FALSE, comment=NA, cache=T}
...
list <- list(spec_data_matrix, hepatitis_data_matrix)
datasets <- c("Spect", "Hepatitis")
...
Now let's put these algorithms in a tournamet against eachother and see who wins :D
